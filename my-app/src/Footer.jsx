    ...
    <>
      <footer className='footer'>
        ...
        <div className='image-container'>
          ...
          <a href="https://github.com/jack-pap" target="_blank" rel="noreferrer">
            <svg id="gitIcon" xmlns="http://www.w3.org/2000/svg" alt="Github Icon" viewBox="0 0 24 24">
             ...
             3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg>
          </a>
        </div>
